...
constexpr OBJECT_TYPE OBJECT_TYPE_MAX = OBJECT_TYPE_INVENTORY;
...
enum ITEM_SUBTYPE : int {
  ...
  WEARABLE_TYPE_HELMET = 6,
  WEARABLE_TYPE_ARMOR = 7,
  WEARABLE_TYPE_PANTS = 8,
  WEARABLE_TYPE_BOOTS = 9,
  ETC = 10,
...
constexpr MONSTER_TYPE MONSTER_TYPE_MAX = MONSTER_TYPE_SNAKE;
