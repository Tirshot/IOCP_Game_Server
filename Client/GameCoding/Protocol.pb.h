...
extern S_HealEffectDefaultTypeInternal _S_HealEffect_default_instance_;
class S_Hit;
...
template<> ::Protocol::S_HealEffect* Arena::CreateMaybeMessage<::Protocol::S_HealEffect>(Arena*);
...
class S_HealEffect final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.S_HealEffect) */ {
 public:
  inline S_HealEffect() : S_HealEffect(nullptr) {}
  ~S_HealEffect() override;
  explicit PROTOBUF_CONSTEXPR S_HealEffect(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  S_HealEffect(const S_HealEffect& from);
  S_HealEffect(S_HealEffect&& from) noexcept
    : S_HealEffect() {
    *this = ::std::move(from);
  }

  inline S_HealEffect& operator=(const S_HealEffect& from) {
    CopyFrom(from);
    return *this;
  }
  inline S_HealEffect& operator=(S_HealEffect&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const S_HealEffect& default_instance() {
    return *internal_default_instance();
  }
  static inline const S_HealEffect* internal_default_instance() {
    return reinterpret_cast<const S_HealEffect*>(
               &_S_HealEffect_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    31;

  friend void swap(S_HealEffect& a, S_HealEffect& b) {
    a.Swap(&b);
  }
  inline void Swap(S_HealEffect* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(S_HealEffect* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  S_HealEffect* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<S_HealEffect>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const S_HealEffect& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const S_HealEffect& from) {
    S_HealEffect::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(S_HealEffect* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.S_HealEffect";
  }
  protected:
  explicit S_HealEffect(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.S_HealEffect)
 private:
  class _Internal;
...
// bool revive = 2;
inline void S_AddObject::clear_revive() {
  _impl_.revive_ = false;
}
inline bool S_AddObject::_internal_revive() const {
  return _impl_.revive_;
}
inline bool S_AddObject::revive() const {
  // @@protoc_insertion_point(field_get:Protocol.S_AddObject.revive)
  return _internal_revive();
}
inline void S_AddObject::_internal_set_revive(bool value) {
  
  _impl_.revive_ = value;
}
inline void S_AddObject::set_revive(bool value) {
  _internal_set_revive(value);
  // @@protoc_insertion_point(field_set:Protocol.S_AddObject.revive)
}
...
// uint64 objectId = 1;
inline void S_HealEffect::clear_objectid() {
  _impl_.objectid_ = uint64_t{0u};
}
inline uint64_t S_HealEffect::_internal_objectid() const {
  return _impl_.objectid_;
}
inline uint64_t S_HealEffect::objectid() const {
  // @@protoc_insertion_point(field_get:Protocol.S_HealEffect.objectId)
  return _internal_objectid();
}
inline void S_HealEffect::_internal_set_objectid(uint64_t value) {
  
  _impl_.objectid_ = value;
}
inline void S_HealEffect::set_objectid(uint64_t value) {
  _internal_set_objectid(value);
  // @@protoc_insertion_point(field_set:Protocol.S_HealEffect.objectId)
}

// int32 posX = 2;
inline void S_HealEffect::clear_posx() {
  _impl_.posx_ = 0;
}
inline int32_t S_HealEffect::_internal_posx() const {
  return _impl_.posx_;
}
inline int32_t S_HealEffect::posx() const {
  // @@protoc_insertion_point(field_get:Protocol.S_HealEffect.posX)
  return _internal_posx();
}
inline void S_HealEffect::_internal_set_posx(int32_t value) {
  
  _impl_.posx_ = value;
}
inline void S_HealEffect::set_posx(int32_t value) {
  _internal_set_posx(value);
  // @@protoc_insertion_point(field_set:Protocol.S_HealEffect.posX)
}

// int32 posY = 3;
inline void S_HealEffect::clear_posy() {
  _impl_.posy_ = 0;
}
inline int32_t S_HealEffect::_internal_posy() const {
  return _impl_.posy_;
}
inline int32_t S_HealEffect::posy() const {
  // @@protoc_insertion_point(field_get:Protocol.S_HealEffect.posY)
  return _internal_posy();
}
inline void S_HealEffect::_internal_set_posy(int32_t value) {
  
  _impl_.posy_ = value;
}
inline void S_HealEffect::set_posy(int32_t value) {
  _internal_set_posy(value);
  // @@protoc_insertion_point(field_set:Protocol.S_HealEffect.posY)
}
